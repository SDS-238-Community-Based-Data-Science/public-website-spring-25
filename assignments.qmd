...
In 500-600 words, you should reflect on the extent to which the practices you engaged and the work you completed for the course project embody the principles of design justice. Refer back to the design justice principles that we outlined in the project proposal. You will find this in our [Shared Google Drive](https://drive.google.com/drive/folders/1iIbmV0Nd67fMtKELhwJrj65qKtRQwP8B?usp=drive_link). In what specific ways did the work that you completed for this project embody **each** of the principles we outlined at the start of the semester? For each principle, you should give a *specific* example of something that you (individually or as a team) did to embody that principle and/or something you could have done differently to better embody that principle. In drawing this out, you are welcome to think about approaches that you might have taken in the constraints of a 13-week semester with limited resources, or alternatively approaches you might have taken if you had unlimited time and resources. For credit, your response must address all five principles that we outlined in the project proposal. Please clearly mark each in your write-up. 