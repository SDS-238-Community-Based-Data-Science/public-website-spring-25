...
When we engage in "real world" data science projects, it is very often the case that we confront tasks that we do not currently know how to tackle. In this write-up, in 300-400 words, you should reflect on your personal experience of having to learn how to do things that you did not yet know how to do in the course project. What were some things you had to learn how to do to complete your assigned tasks? What were your first reactions to confronting an unfamiliar task? How did you engage in independent learning to figure out how to tackle that task? What resources did you engage? What was it like to acquire that knowledge and skill independently? Were there frustrations or celebrations along the way? Are there ways that you'd like to take better advantage of support resources available to you in the future? There is no required format for this write-up; it may be written like a journal entry. I simply want to see that you are reflecting on your personal role in your collaboration. 
